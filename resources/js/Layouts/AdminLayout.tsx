...
export default function AdminLayout({ children }: PropsWithChildren) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex transition-colors duration-300">
            {/* Sidebar */}
            <aside className="fixed inset-y-0 left-0 w-72 bg-gray-900 text-white flex flex-col z-50">
                <div className="p-8 flex items-center gap-3 border-b border-gray-800">
                    ...
                    <div>
                        <h1 className="text-xl font-black tracking-tight">EVEREST</h1>
                        <p className="text-[10px] font-bold text-primary uppercase tracking-widest">Painel Admin</p>
                    </div>
                </div>
                ...
                <div className="p-6 border-t border-gray-800">
                    <Link href={route('dashboard')} className="flex items-center gap-3 text-gray-500 hover:text-white transition-colors text-sm font-bold">
            ...
            <div className="flex-1 ml-72">
                <header className="h-20 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-10 flex items-center justify-between sticky top-0 z-40">
                    <h2 className="text-xl font-black text-gray-900 dark:text-white">Gerenciamento</h2>
                    
                    <div className="flex items-center gap-6">
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-bold dark:text-white">{user.name}</p>
                            <p className="text-[10px] text-primary font-black uppercase">Administrador</p>
                        </div>
