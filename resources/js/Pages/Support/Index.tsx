...
export default function SupportIndex() {
    ...
    return (
        <div
            className="bg-background-light dark:bg-background-dark text-[#111815] transition-colors duration-300 min-h-screen flex flex-col font-display"
            ref={mainRef}
        >
            ...
            <LegalNavbar>
                <Link
                    className="px-5 py-2 rounded-full bg-primary text-[#111815] text-sm font-bold shadow-sm hover:scale-105 transition-transform"
            ...
            <main className="flex-1">
                ...
                >
                    <div className="max-w-[800px] mx-auto text-center support-hero">
                        <h1 className="text-4xl md:text-5xl font-black text-[#111815] dark:text-white mb-6 tracking-tight">
                            Central de Ajuda
                        </h1>
                        <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
                            Tudo o que você precisa para conquistar seus
                            objetivos sem obstáculos.
                        </p>
                ...
                <section className="max-w-[1200px] mx-auto px-4 py-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 support-category-grid">
                        <a
                            className="group bg-white dark:bg-gray-800 p-8 rounded-3xl border border-[#dbe6e1] dark:border-gray-700 hover:border-primary dark:hover:border-primary transition-all hover:shadow-lg hover:-translate-y-1 support-category-card"
                            href="#"
                        >
                            ...
                            <h3 className="text-xl font-bold text-[#111815] dark:text-white mb-2">
                                Problemas de Login
                            </h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Recuperação de senha, autenticação e segurança
                                da conta.
                            </p>
                        </a>
                        <a
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Como criar, editar e acompanhar seu progresso no
                                Everest.
                            </p>
                        </a>
                        <a
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Entenda como funcionam os níveis, badges e
                                recompensas.
                            </p>
                        </a>
                ...
                <section className="bg-white dark:bg-gray-900 border-y border-[#dbe6e1] dark:border-gray-800 py-20">
                    <div className="max-w-[800px] mx-auto px-4">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-black text-[#111815] dark:text-white mb-4">
                                Fale Conosco
                            </h2>
                            <p className="text-gray-500 dark:text-gray-400">
                                Não encontrou o que procurava? Nossa equipe de
                                especialistas está pronta para te ajudar a
                                chegar no topo.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 support-contact-grid">
                            <div className="flex items-start gap-4 p-6 rounded-3xl bg-background-light dark:bg-gray-800 border border-[#dbe6e1] dark:border-gray-700 hover:border-primary transition-colors support-contact-card">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#111815] dark:text-white text-lg">
                                        E-mail
                                    </h4>
                                    ...
                                    <a
                                        href="mailto:suporte@everest.app"
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 md:p-10 rounded-[2rem] border border-[#dbe6e1] dark:border-gray-700 shadow-xl relative overflow-hidden support-form-container">
                            {flash?.success ? (
                                <div className="flex flex-col items-center justify-center py-10 text-center animate-fade-in">
                                    ...
                                    <h3 className="text-2xl font-black text-[#111815] dark:text-white mb-2">
                                        Mensagem enviada!
                                    </h3>
                                    <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-8">
                                        Recebemos sua solicitação e nossa equipe
                                        entrará em contato em breve. Um
                                        protocolo foi enviado para o seu e-mail.
                                    </p>
                                    <button
                                ...
                                <form onSubmit={submit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex justify-end mt-1">
                                            <span
                                                className={`text-xs ${data.message.length >= 5000 ? "text-red-500" : "text-gray-400"}`}
                                            >
