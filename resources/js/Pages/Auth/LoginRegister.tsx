...
export default function LoginRegister({
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        nickname: socialUser?.name
            ? socialUser.name.toLowerCase().replace(/\s+/g, "_")
            : "",
                        ...
                        <div className="flex flex-col gap-4">
                            {!socialUser && (
                                <>
                                    <a
                                        href="/oauth2/google"
                                        className="w-full flex items-center justify-center gap-3 rounded-full h-12 px-6 bg-white dark:bg-gray-700 border border-[#dbe6e1] dark:border-gray-600 text-[#111815] dark:text-white text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
                                    >
                                        <svg
                                            className="w-5 h-5"
                                            viewBox="0 0 24 24"
                                    ...
                                    <>
                                        ...
                                        <div>
                                            <div className="flex justify-between items-center mb-2">
                                                <label
                                                    className="block text-sm font-bold text-[#111815] dark:text-gray-300"
                                                    htmlFor="password"
                                                >
                                                    Senha
                                                </label>
